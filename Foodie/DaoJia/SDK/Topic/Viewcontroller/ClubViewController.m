...
//    topicTableView.backgroundColor = [UIColor redColor];
...
//    peopleTableView.backgroundColor = [UIColor blackColor];
...
//    __weak typeof(peopleTableView) weakPeoTableView = peopleTableView;
    
    [manager POST:str parameters:dic progress:NULL success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
